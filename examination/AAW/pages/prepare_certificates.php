...
<div class="box-header">
    <h3 class="box-title">Issue Certificates</h3>
</div><!-- /.box-header -->
            ...
            <div class="modal-body">
                <div style="padding: 20px;">
                    <table>
                        ...
                        <td>Name:Md. Jamal</td></tr>


                        <td>Roll:CE-01001</td></tr>
                        <td>Department:CSE</td></tr>
                        <td>Semester:Spring</td></tr>
                        <td>Year:2011</td></tr>


                        <td> Certificate:  <img src="../img/doc.png" width="50px" style="cursor: pointer"></td>
...
<!-- View Details Modal -->
<div class="modal fade" id="print" tabindex="-1" role="dialog" aria-labelledby="viewDetails" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-info" data-dismiss="modal">Print</button>
