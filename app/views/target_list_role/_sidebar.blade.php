    ...
    <div id="collapseOne" class="panel-collapse collapse in">
        <div class="panel-body">
            <table class="table">
                <tr>
                    <td>
                      <a href="{{ action('TaskListRoleController@index') }}">All Target List</a> <span class="label label-success"></span>
                    </td>
                </tr>
                <tr>
                    <td>
                     <a href="{{ action('TaskListRoleController@create') }}">Create Target List</a> <span class="label label-info"></span>
                    </td>
                </tr>
                <tr>
    ...
    <div id="collapseThree" class="panel-collapse collapse">
        <div class="panel-body">
            <table class="table">
                <tr>
                    <td>
                        <a href="{{ action('CourseController@index') }}">All Courses</a> <span class="label label-success"></span>
                    </td>
                </tr>
                <tr>
                    <td>
                        <a href="{{ action('CourseController@create') }}">Create New Course</a> <span class="label label-info"></span>
                    </td>
                </tr>
                <tr>
       ...
       <div id="collapseSix" class="panel-collapse collapse">
           <div class="panel-body">
               <table class="table">
                   ...
                   <tr>
                       <td>
                           <a href="{{ action('CourseTypeController@create') }}">Create New  Course Type</a> <span class="label label-info"></span>
                       </td>
                   </tr>
                   <tr>
