<div class="modal-header">
    ...
    <h4 class="modal-title" style="text-align: center;color: #800080;">Edit Publisher :: {{isset($edit_publisher->name) ? $edit_publisher->name :''}} Information</h4>
</div>
<div class="modal-body">
    <div style="padding: 10px;">
        {{Form::model($edit_publisher, array('route' => array('publisher.update', $edit_publisher->id)))}}
        ...
        <div class='form-group'>
            <div>{{ Form::label('company_name', 'Company Name') }}</div>
            <div>{{ Form::text('company_name', Input::old('company_name'),['class'=>'form-control','spellcheck'=> 'true','required'=>'required']) }}
            </div>
        </div>
