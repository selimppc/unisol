...
<div class="list-group">
    <a href= "{{URL::to('applicant/profile/index') }}" class="list-group-item">Personal Information</a>
    ...
    <a href="{{URL::to('applicant/profile') }}" class="list-group-item">Supporting Documents</a>
