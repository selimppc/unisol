...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">Details Information Of Academic Records</h4>
</div>
...
<table style="font-size: large">
    ...
    <tr>
     ...
     <tr>
        ...
        <a href="{{URL::to('applicant/acm_records/') }} " class="pull-right btn btn-default" span class="glyphicon-refresh">Close</a>
<br>
        {{Form::close()}}
  </div>
</div>
