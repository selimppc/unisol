<div class="modal-header">
    ...
    <h4 class="modal-title" style="text-align: center;color: #800080;font-size: x-large">Create Academic Records </h4>
</div>
<div>&nbsp;</div>
...
<div class="modal-footer">
    ...
    <a href="{{URL::to('apt/acm_records/')}}" class="btn btn-default pull-right">Close </a>
</div>
<br>
{{ Form::close() }}
