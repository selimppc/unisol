            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_1">
                        ...
                        <a class="pull-right btn btn-success"  href="{{url::to('admission/public/admission/add-applicant-acm-docs')}}" data-toggle="modal" data-target="#addModal"><b></b> Add Academic Records <i class="fa fa-arrow-circle-right"></i></a>
