        ...
        <div class="box box-solid">
            ...
            <div class="box-body" style="padding: 30px;">
               ...
               @foreach($reply_data as $v)
                        @if($v->replied_by =='user')
                            <p style="padding: 1%; background: #efefef;">
                               <b style="font-size: medium">User Query/Response :</b><br>{{ isset($v->message)?$v->message:'' }}<br>
                            </p>
                        @endif
               ...
               <p>&nbsp;</p>
                  ...
                  @endif
                  <p>&nbsp;</p>
                   <a href="{{ URL::route('support-head.index')}}" class="pull-right btn btn-xs btn-success" style="margin-left: 5px">Cancel</a>
