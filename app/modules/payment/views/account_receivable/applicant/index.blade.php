                 ...
                 <tr style="{{$values->status=='invoiced' ? 'background-color: burlywood' : '' }}">
                    ...
                    <td>
                        @if($values->status != 'Invoiced')
                            <a href="{{ URL::route('create/purchase-order', ['bah_id'=>$values->id ]) }}" class="btn btn-xs btn-default" ><i class="fa fa-adjust" style="color: darkslategray" data-toggle="tooltip" data-placement="bottom" title="Add VAT"></i> + VAT</a>
                        @endif
                    </td>
