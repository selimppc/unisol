{{Form::hidden('exm_question_id', $fclty_edit_exm_quest_items->exm_question_id, ['class'=>'form-control'])}}

      <div class='form-group'>
         <Strong> Question Paper : </Strong> {{ $fclty_edit_exm_quest_items->relExmQuestion->title }}
      </div>
     ...
     <div class="form-group" id="myRadioGroup" style="display: inline-block;">
        ...
        <div class="radio">
             <label>
                  {{ Form::radio('mcq', 'MCQ', ($fclty_edit_exm_quest_items->question_type != 'text'), ['id'=>'mcq_change', 'class'=>'radio']) }}
                  MCQ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
             </label>
             <label>
                  {{ Form::radio('mcq', 'Descriptive', ($fclty_edit_exm_quest_items->question_type == 'text'), ['id'=>'des_change', 'class'=>'radio']) }}
                  Descriptive
             </label>
        </div>
     </div>
     ...
     <div class="container">
        <div class="row">
           @if($fclty_edit_exm_quest_items->question_type != 'text')
               <div id="mcq_all" class="mcq_all_item" >
                     <div class="form-group" style="display: inline-block;">
                             {{ Form::label('Answer Type:') }}
                             <div class="radio">
                                  <label>
                                       {{ Form::radio('q_type', 'mcq_single', ($fclty_edit_exm_quest_items->question_type == 'radio'), ['id'=>'single', 'class'=>'radio']) }}
                                       Single Answer &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                  </label>
                                  <label>
                                       {{ Form::radio('q_type', 'mcq_multiple', ($fclty_edit_exm_quest_items->question_type == 'checkbox'), ['id'=>'multiple', 'class'=>'radio']) }}
                                       Multiple Answer
                                  </label>
                             </div>
                     </div>
                     ...
                     <div id="myRadioGroup" class="row">
                          ...
                          @foreach($faculty_edit_exm_quest_options as $op)
                              <div class="col-sm-8">
                                  <div class="col-sm-4">
                                  ...
                                  <div class="col-sm-4">
                                         @if($fclty_edit_exm_quest_items->question_type == 'radio')
                                              {{ Form::radio('answer[]',$counter, ($op->answer == 1), ['id'=>'single','class'=>'radiocheck']) }}

                                         @elseif($fclty_edit_exm_quest_items->question_type == 'checkbox')
