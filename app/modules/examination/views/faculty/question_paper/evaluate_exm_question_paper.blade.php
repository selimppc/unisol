...
{{--                                                @if(!isset($evaluation_exm_qp))--}}
                                                    @foreach($evaluation_exm_qp as $evaluation)
                                                        ...
                                                        <td><input type="checkbox" name="id[]" class="myCheckbox" value="{{ $evaluation['id'] }}"></td>
                                                            ...
                                                            <td width="140">
                                                                <a href="{{ URL::route('faculty.exm-question-paper.evaluate-exm-questions-items',['e_q_id'=>$evaluation->exm_question_id , 'no_q'=>0 ,'evaluation_id'=>$evaluation->id, ]) }}" class="btn bg-orange btn-xs " >Evaluate</a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                {{--@endif--}}
