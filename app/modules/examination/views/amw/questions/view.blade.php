...
<div class="modal-header">
    ...
    <h4 style="text-align: center;"><span style="color: seagreen">View Question Item : {{ isset($question_item->title) ? $question_item->title :'' }}</span></h4>
</div>
     ...
     <table id="" class="table table-bordered table-hover table-striped" style="font-size: medium">
        ...
        <div class="container">
            <div class="row">
                ...
                <strong>{{ isset($question_item->title)? $question_item->title :'' }}</strong>
                        ...
                        <div class="col-sm-12">
                             <div class="col-sm-6">
                                 <div class="col-sm-6">
                                     ...
                                     <td>{{isset($op->title)?$op->title:''}}</td><br>
                                 </div>
                                 <div class="col-sm-4">
                                     @if($op->answer == 1)
