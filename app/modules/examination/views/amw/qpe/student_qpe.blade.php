...
<h4> Question Paper Evaluation for Subject and Student(s)</h4>
...
<div class="box">
    ...
    <div class="box-body table-responsive">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tbody>
            @foreach($exm_question_evaluation as $values)
              <tr>
                <td> {{User::FullName($values->student_user_id)}} </td>
                <td> TBD </td>
                <td> TBD </td>
                <td>
                    <a href="{{ URL::route('amw.details-qpe', ['student_user_id'=> $values->student_user_id, 'question_id'=> $values->exm_question_id]) }}" class="btn btn-xs btn-default" data-toggle="modal" data-target="#modal"><span class="fa fa-eye"></span> view </a>
                </td>
              </tr>
            @endforeach
            </tbody>
