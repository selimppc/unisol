...
<div class="modal-body">
    <div class="row" style="padding: 3%">
        <div class="row">
            <div class="col-xs-6">
                <b>Subject Name</b> : {{isset($data->relCourseConduct->relCourse->relSubject->title)?$data->relCourseConduct->relCourse->relSubject->title : ''}}
            </div>
            <div class="col-xs-6">
                <b>Total Marks</b> : {{isset($data->total_marks) ? $data->total_marks : ''}}
            </div>
            <div class="col-xs-6">
                <b>Total# of Question : </b> : {{isset($count->total) ? $count->total : ''}}
            </div>
            <div class="col-xs-6">
                <b>Marks Obtain </b> : {{isset($count->marks) ? $count->marks : ''}}
            </div>
        </div>
