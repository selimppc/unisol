                      ...
                      @foreach($question_paper as $prepare_question_paper_amw)
                            <tr>
                                ...
                                <td>
                                   ...
                                   <a href="{{ URL::route('examination.amw.assign_faculty', ['id'=>$prepare_question_paper_amw->id])  }}" class="btn btn-default" data-toggle="modal" data-target="#ass_fac" data-placement="left" title="Assign Faculty" href="#">Assign Faculty</a>
