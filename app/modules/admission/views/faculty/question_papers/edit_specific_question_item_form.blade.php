           ...
           @if($faculty_editQuestionItems->question_type != 'text')
               <div id="mcq_all" class="mcq_all_item" >
                     <div class="form-group" style="display: inline-block;">
                             ...
                             <div class="radio">
                                  <label>
                                       {{ Form::radio('r_c', 'mcq_single',($faculty_editQuestionItems->question_type == 'radio'), ['id'=>'single', 'class'=>'radio']) }}
                                       Single Answer &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                  </label>
                                  <label>
                                       {{ Form::radio('r_c', 'mcq_multiple',($faculty_editQuestionItems->question_type == 'checkbox'), ['id'=>'multiple', 'class'=>'radio']) }}
                                       Multiple Answer
                                  </label>
                             </div>
                     </div>
