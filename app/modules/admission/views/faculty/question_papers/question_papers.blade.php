                          ...
                          @foreach($admtest_question_paper as $admtest_question_paper_list)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ URL::route('admission.faculty.question-papers.view-questions-items',['id'=>$admtest_question_paper_list->id]) }}" class="btn btn-primary btn-xs" data-toggle="modal" data-target="#modal" >VQs</a>
