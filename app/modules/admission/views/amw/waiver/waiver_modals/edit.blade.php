...
{{ Form::open(['route' => ['admission.amw.waiver.update',$waiver_model->id], 'class'=>'form-horizontal','files' => true,]) }}
     ...
     {{ Form::textarea('description', $waiver_model->description,array('onkeyup'=>"javascript:this.value=this.value.replace(/[<,>]/g,'');",'class' => 'form-control input-sm','placeholder'=>'Enter Description','size' => '30x5')) }}
