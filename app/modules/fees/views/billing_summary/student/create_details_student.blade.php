...
<div class="modal-body">
    <div style="padding: 10px;">
        ...
        <div class="pull-right">
            <div class='form-group' style="margin-right: 4px">
                <input type="button" class="btn btn-primary" id="add_billing_student_detail" value="+Add">
            </div>
        </div>
        <div>&nbsp;</div>
        <div>&nbsp;</div>
    ...
    {{Form::open(array('route' => array('billing.details.student.save')))}}
        ...
        @foreach ($billing_details_data as $value)
            <tr>
                <td>{{isset($value->relBillingItem->title)?$value->relBillingItem->title:''}}
                    {{ Form::hidden('billing_student_detail_id[]', $value->id)}}
                </td>
