        ...
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <a href="{{URL::route('applicant-billing-history')}}" class="btn btn-default fa fa-eye text-light-blue btn-width">All Applicant Fees History</a>
                                       ...
                                       <td class="b-text">{{ link_to_route($value->status=="open" ? 'billing.details.applicant' : 'billing-applicant-view',$value->relApplicant->first_name.' '.$value->relApplicant->last_name,['id'=>$value->id], ['data-toggle'=>"modal",'data-target'=>"#createModal"]) }}</td>
                                        ...
                                        <td>
                                            @if($value->status != 'confirmed')
                                              ...
                                              <a href="{{ URL::route('status-billing-applicant-head-update', ['id'=>$value->id ])}}" class="btn btn-xs btn-warning" data-toggle="modal" data-target="#confirmStatus" title="Click to Confirm"><i class="fa fa-check-square-o"></i> Confirm</a>
                                            @endif
                                        </td>
                                    </tr>
                                    @endunless
