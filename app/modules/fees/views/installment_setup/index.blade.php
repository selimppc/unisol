                ...
                {{Form::open()}}
                        <div class="col-sm-12" style="background: #EEEEEE">
                            ...
                            <div class="col-sm-2">
                                ...
                                {{ Form::select('batch_id', $batch, Input::old('batch_id'), ['id'=>'dependable-list', 'class'=>'form-control','placeholder'=>'','required'=>'required']) }}
                            </div>
                            <div class="col-sm-3">
                    ...
                    <div class="box-body table-responsive ">
                        <div id="viewTable" style="visibility: hidden;">
                            <table class="table table-bordered small-header-table" >
                                ...
                                <tbody>
                                <td>{{ Form::text('amount', Input::old('amount'),['class'=>'form-control','required'=>'required']) }}</td>
