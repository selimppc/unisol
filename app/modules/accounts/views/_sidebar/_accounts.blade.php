{{--<ul class="sidebar-menu">
    ...
    <li class="treeview">
        ...
        <ul class="treeview-menu">
            ...
            <li><a href="{{Route('rnc-receivable-index')}}"><i class="fa fa-angle-double-right"></i> RNC </a></li>
            <li><a href="{{Route('setup-transaction')}}"><i class="fa fa-angle-double-right"></i> Settings </a></li>
    ...
    <li class="treeview">
        <a href="#">
            <i class="fa fa-usd"></i><span> Account Payable </span><i class="fa fa-angle-left pull-right"></i>
        </a>
        <ul class="treeview-menu">
            ...
            <li><a href="{{URL::route('manage-ap')}}"><i class="fa fa-angle-double-right"></i> RNC </a></li>
