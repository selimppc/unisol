...
class RnCStudentController extends \BaseController {
    ...
    public function indexCategory()
    {
        ...
        return View::make('rnc::student.category.index', compact('model'));
    }
    ...
    public function showCategory($id)
    {
        ...
        if($model)
        {
            return View::make('rnc::student.category.show',compact('model'));
        }
        App::abort(404);
    }
    ...
    {
        $model = RnCCategory::find($id);
        return View::make('rnc::student.category.edit',compact('model'));
    }
    ...
    public function indexPublisher()
    {
        ...
        return View::make('rnc::student.publisher.index', compact('publisher'));
    }
    ...
    public function showPublisher($id)
    {
        ...
        if($publisher)
        {
            return View::make('rnc::student.publisher.show',compact('publisher'));
        }
        App::abort(404);
    }
    ...
    {
        $publisher = RnCPublisher::find($id);
        return View::make('rnc::student.publisher.edit',compact('publisher'));
    }
