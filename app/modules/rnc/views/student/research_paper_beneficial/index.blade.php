                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_1">
                        <div class="box-body table-responsive ">
                            ...
                            {{Form::open(array('route'=> ['student.research-paper-beneficial.batch-delete'], 'class'=>'form-horizontal','files'=>true))}}
                                ...
                                @if(isset($rnc_r_p_beneficial))
                                    @foreach ($rnc_r_p_beneficial as $value)
                                        <tr>
                                            ...
                                            <td>
                                               <a href="{{ URL::route('student.research-paper-beneficial.show', ['id'=>$value->id])  }}" class="btn btn-xs btn-default" data-toggle="modal" data-target="#show" href=""><i class="fa fa-eye" style="color: green"></i></a>
                                               <a href="{{ URL::route('student.research-paper-beneficial.edit', ['id'=>$value->id]) }}" class="btn btn-xs btn-default" data-toggle="modal" data-target="#edit" href="" ><i class="fa fa-pencil-square-o" style="color: #0044cc"></i></a>
                                               <a data-href="{{ URL::route('student.research-paper-beneficial.delete', ['id'=>$value->id]) }}" class="btn btn-xs btn-default" data-toggle="modal" data-target="#confirm-delete" href="" ><i class="fa fa-trash-o" style="color: red"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                @endif
        ...
        <div class="modal-dialog" aria-hidden="true" data-keyboard="false" data-backdrop="static">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open(array('url' => 'rnc/student/research-paper-beneficial/store', 'method' =>'post', 'role'=>'form')) }}
                        @include('rnc::student.research_paper_beneficial._form')
                    {{ Form::close() }}
                </div>
            </div>
        </div>
