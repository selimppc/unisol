...
@stop
@section('content')
<a class="pull-right btn btn-info btn-xs"  style="color: #ffffff" href="{{ URL::route('student.research-paper.index') }}" id="addBook"><b>Home</b></a>
       ...
       <div class="box box-solid">
        ...
        <b style="margin-left: 10px"> Total price : {{ $sum }} </b></div>
           ...
           <div class="box-tools pull-right" style="margin-left: 50%">
               <a class="pull-right btn btn-large btn-info" href="{{ URL::route('student.research-paper.payment')}}"><b style="color: #f4f5ff;">Payment Option</b> <i class="fa  fa-arrow-right"></i></a>
           </div>
       </div>
    </div>
 </div>
