               ...
               <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <a class="pull-right btn btn-sm btn-info" style="margin-right: 5px"
                        href="{{ URL::route('student.category.add') }}"
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1">
                            ...
                            {{ Form::open(array('url' => 'rnc/student/category/batch-delete')) }}
                                    ...
                                    @if(isset($model))
                                        @foreach ($model as $value)
                                            <tr>
                                                ...
                                                <td>{{$value->title}}</td>
                                                <td>
                                                    <a href="{{ URL::route('student.category.show', ['id'=>$value->id])  }}" class="btn btn-xs btn-default" data-toggle="modal" data-target="#show" href=""><i class="fa fa-eye" style="color: green"></i></a>
                                                    <a href="{{ URL::route('student.category.edit', ['id'=>$value->id]) }}" class="btn btn-xs btn-default" data-toggle="modal" data-target="#edit" href="" ><i class="fa fa-pencil-square-o" style="color: #0044cc"></i></a>
                                                    <a data-href="{{ URL::route('student.category.delete', ['id'=>$value->id]) }}" class="btn btn-xs btn-default" data-toggle="modal" data-target="#confirm-delete" href="" ><i class="fa fa-trash-o" style="color: red"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                     <a href="{{URL::to('rnc/student/category/index')}}" class="btn btn-default">Cancel</a>
    ...
    <div id="add" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open(array('url' => 'rnc/student/category/store', 'method' =>'post', 'role'=>'form','files'=>'true')) }}
                        @include('rnc::student.category._form')
                    {{ Form::close() }}
                </div>
                <div class="modal-footer">
                </div>
