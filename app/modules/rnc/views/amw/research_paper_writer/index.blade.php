                            ...
                            <table id="example" class="table table-bordered table-hover table-striped scrollit">
                                ...
                                @foreach ($rnc_r_p_writer as $value)
                                    <tr>
                                        ...
                                        <td>
                                           <a href="{{ URL::route('amw.research-paper-writer.show', ['id'=>$value->id])  }}" class="btn btn-xs btn-default" data-toggle="modal" data-target="#show" href=""><i class="fa fa-eye" style="color: green"></i></a>
                                           <a href="{{ URL::route('amw.research-paper-writer.edit', ['id'=>$value->id]) }}" class="btn btn-xs btn-default" data-toggle="modal" data-target="#edit" href="" ><i class="fa fa-pencil-square-o" style="color: #0044cc"></i></a>
                                           <a data-href="{{ URL::route('amw.research-paper-writer.delete', ['id'=>$value->id]) }}" class="btn btn-xs btn-default" data-toggle="modal" data-target="#confirm-delete" href="" ><i class="fa fa-trash-o" style="color: red"></i></a>
                                           <a href="{{ URL::route('amw.research-paper-beneficial.index', [ 'rnc_r_p_id'=>$value->rnc_research_paper_id , 'w_id'=>$value->id ]) }}" class="btn btn-xs btn-primary" ></i>Beneficial</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open(array('url' => 'rnc/amw/research-paper-writer/store', 'method' =>'post', 'role'=>'form')) }}
                        @include('rnc::amw.research_paper_writer._form')
                    {{ Form::close() }}
                </div>
            </div>
        </div>
