                                ...
                                @foreach ($research_paper as $value)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ URL::route('amw.research-paper.comment', ['rnc_r_p_id'=>$value->id]) }}" class="btn btn-xs btn-default" data-toggle="modal" data-target="#commentModal" href="" ><i class="fa fa-comments" style="color: mediumpurple" title="Comemnt"></i></a>
