                            ...
                            <table id="example" class="table table-bordered table-hover table-striped scrollit">
                                ...
                                @foreach ($research_paper as $value)
                                    <tr>
                                        ...
                                        @endif
                                        <td>
                                            <a href="{{ URL::route('amw.research-paper.view', ['id'=>$value->id]) }}" class="btn btn-xs btn-default" data-toggle="modal" data-target="#modal" href=""><i class="fa fa-eye" style="color: green" title="View"></i></a>
                                            <a href="{{ URL::route('amw.research-paper.edit', ['id'=>$value->id]) }}" class="btn btn-xs btn-default" data-toggle="modal" data-target="#modal" href="" ><i class="fa fa-pencil-square-o" style="color: #0044cc" title="Edit"></i></a>
