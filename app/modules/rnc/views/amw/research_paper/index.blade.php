                                ...
                                @foreach ($research_paper as $value)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ URL::route('amw.research-paper.comment', ['rnc_r_p_id'=>$value->id]) }}" class="btn btn-xs btn-primary" data-toggle="modal" data-target="#commentModal" href="" >Comment</a>
