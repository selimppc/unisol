                           ...
                           <tr>
                               ...
                               <td>
                                        @if($mcrps->relRnCFinancialTransaction->status == "paid")
                                            <a href="{{ URL::route('faculty.research-paper.purchased-download',['rnc_rp_id'=>$mcrps->relRnCResearchPaper->id]) }}" class="btn btn-xs btn-default"><i class="fa fa-cloud-download " style="color: blue" title="Purchased"></i> Download</a>
                                        @else
