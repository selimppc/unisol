 ...
 <div class="box box-solid">
    <div class="box-header">
       ...
       <div style="margin-left: 40%">
            <a href="{{ URL::route('faculty.research-paper.index') }}" class="btn btn-info"><b>Home</b></a>
            <a href="{{ URL::previous() }}" class="btn btn-primary"><b>Back</b></a>
            <a href="{{ URL::route('faculty.research-paper.send-info-to-transaction') }}" class="btn btn-success" ><b><i class="fa fa-mail-forward"></i>  CHECKOUT</b></a>
       </div>
