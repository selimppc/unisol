               ...
               <div class="col-md-12">
                ...
                <div class="nav-tabs-custom">
                    ...
                    <a class="pull-right btn btn-sm btn-info" style="margin-right: 5px"
                        href="{{ URL::route('faculty.config.add') }}"
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab_1">
                            ...
                            {{ Form::open(array('url' => 'rnc/faculty/config/batch-delete')) }}
                                        ...
                                        @foreach ($config as $data)
                                            <tr>
                                                ...
                                                <td>{{ $data->title }}</td>
                                                 <td>{{ $data->value }}</td>
                                                <td>
                                                    <a href="{{ URL::route('faculty.config.show', ['id'=>$data->id])  }}" class="btn btn-xs btn-default" data-toggle="modal" data-target="#show" href=""><i class="fa fa-eye" style="color: green"></i></a>
                                                    <a href="{{ URL::route('faculty.config.edit', ['id'=>$data->id]) }}" class="btn btn-xs btn-default" data-toggle="modal" data-target="#edit" href="" ><i class="fa fa-pencil-square-o" style="color: #0044cc"></i></a>
                                                    <a data-href="{{ URL::route('faculty.config.delete', ['id'=>$data->id]) }}" class="btn btn-xs btn-default" data-toggle="modal" data-target="#confirm-delete" href="" ><i class="fa fa-trash-o" style="color: red"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                     <a href="{{URL::to('rnc/faculty/config/index')}}" class="btn btn-default">Cancel</a>
    ...
    <div id="add" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open(array('url' => 'rnc/faculty/config/store', 'method' =>'post', 'role'=>'form','files'=>'true')) }}
