                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="tab_1">
                        <div class="box-body table-responsive ">
                            ...
                            {{Form::open(array('route'=> ['faculty.research-paper-writer.batch-delete'], 'class'=>'form-horizontal','files'=>true))}}
        ...
        <div class="modal-dialog" aria-hidden="true" data-keyboard="false" data-backdrop="static">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {{ Form::open(array('url' => 'rnc/faculty/research-paper-writer/store', 'method' =>'post', 'role'=>'form')) }}
                        @include('rnc::faculty.research_paper_writer._form')
                    {{ Form::close() }}
                </div>
            </div>
        </div>
