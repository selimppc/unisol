                                        ...
                                        <div class="col-lg-12">
                                            <table class="table  table-bordered">
                                                ...
                                                @foreach($completed_course as $value)
                                                    <tr>
                                                    <td>{{isset($value->relBatchCourse->relCourse->title)? $value->relBatchCourse->relCourse->title :''
                                                   }}</td>
                                                    ...
                                                    @foreach($running_course as $value)
                                                        <tr>
															...
															['batch_course_id' => $value->batch_course_id]) }}" class="btn-link" >
                                                                    {{isset($value->relBatchCourse->relCourse->title) ? $value->relBatchCourse->relCourse->title : ''}}
                                                                </a>
                                                            </td>
                                                            <td>{{ isset($value->relBatchCourse->relCourse->credit) ? $value->relBatchCourse->relCourse->credit : ''}}</td>
                                                            <td></td>
