...
@section('content')
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addClassTest" style="margin-bottom: 5px">Add Final Term</button>
    <table id="example" class="table table-bordered table-hover table-striped">
        ...
        @foreach ($datas as $value)
            <tr>
                ...
                <td>
                    <a href="{{ URL::route('finalterm.edit', ['id'=>$value->id]) }}" class="subEdit btn btn-xs btn-default" data-toggle="modal" data-target="#editModal" href="" ><i class="fa fa-pencil-square-o" style="font-size: 18px"></i></a>

                    <a href="{{ URL::route('finalterm.show', ['id'=>$value->id])  }}" class="btn btn-xs btn-default" data-toggle="modal" data-target="#showModal" href=""><i class="fa fa-eye" style="font-size: 18px"></i></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"style="text-align: center ;color: #800080">Marks Distribution Item:Final Term</h4>
                </div>
                <div class="modal-body">
                    {{ Form::open(array('url' => 'final/term/save', 'method' =>'post', 'role'=>'form','files'=>'true')) }}
                    ...
                    @include('academic::faculty.mark_distribution_courses.marks_dist_item_final_term._form')
                    {{ Form::close() }}
                </div>
            </div>
        </div>
