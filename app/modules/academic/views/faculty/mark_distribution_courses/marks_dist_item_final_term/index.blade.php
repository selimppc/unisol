    ...
    <table id="example" class="table table-bordered table-hover table-striped">
        ...
        @foreach ($datas as $value)
            <tr>
                ...
                <td>
                    <a href="{{ URL::route('finalterm.edit', ['id'=>$value->id]) }}" class="subEdit btn btn-xs btn-default" data-toggle="modal" data-target="#editModal" href="" ><i class="fa fa-pencil-square-o"></i></a>

                    <a href="{{ URL::route('finalterm.show', ['id'=>$value->id])  }}" class="btn btn-xs btn-default" data-toggle="modal" data-target="#showModal" href=""><i class="fa fa-eye"></i></a>
