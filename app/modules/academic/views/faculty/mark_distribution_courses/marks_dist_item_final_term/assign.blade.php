...
@section('content')
    ...
    <table id="example" class="table table-bordered table-hover table-striped">
        ...
        @foreach ($cm_data as $value)
            <tr>
                ...
                <td></td>
                <td>
                    <a href="{{ URL::route('finalterm.comments', ['assign_std'=>$value->user_id]) }}" class="btn btn-info btn-xs" data-toggle="modal" data-target="#commentsModal"> Comments </a>
    ...
    <div class="button" style="margin-top: 10px">
        <a href="{{URL::previous('academic/faculty/marks/dist/item/final/term/')}}" class="btn btn-info btn-xs ">Back</a>
