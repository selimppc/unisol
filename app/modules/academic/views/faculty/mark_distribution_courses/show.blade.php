...
@section('content')
    ...
    <p>If Marks Distribution Is Not Done Then Go to Distribution And Make It Done First.
        ...
        {{--</button>--}}
        <a href="{{URL::to('academic/faculty/course/config')}}" class="btn-xs btn-link"> <i class="fa fa-arrow-circle-left"></i> Marks Distribution</a>
    </p>
...
@section('script_section')
    <script>
        {{------------------Faculty Marks Distribution From show page-------------------}}
