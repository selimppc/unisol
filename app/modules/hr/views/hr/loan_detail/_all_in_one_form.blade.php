   ...
   {{ Form::hidden('hr_loan_head_id', $loan_head_id , Input::old('hr_loan_head_id')) }}
    ...
    <div class="col-sm-4">
        <div class='form-group'>
           ...
           {{ Form::text('amount', Input::old('amount'),['id'=>'loan_detail_amount','class'=>'form-control']) }}
        </div>
    </div>
    ...
    <div class="col-sm-4" >
        <div class='form-group'>
           ...
           {{ Form::text('date',  Input::old('date'),['id'=>'loan_detail_date','class'=>'form-control date_picker']) }}
        </div>
    </div>
      ...
      <?php $counter = 0;?>
       @foreach($model as $values)
            <tr>
               ...
               <td>{{ $values->relHrOverTime->sign_out }}</td>
