...
<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel" style="text-align: center">HR LEAVE
      {{--@if(isset($model->hr_employee_id))--}}
        {{--{{isset($model->relHrEmployee->relUser->relUserProfile->first_name)? $model->relHrEmployee->relUser->relUserProfile->first_name:''}}&nbsp;--}}
        {{--{{isset($model->relHrEmployee->relUser->relUserProfile->middle_name)? $model->relHrEmployee->relUser->relUserProfile->middle_name:''}}&nbsp;--}}
        {{--{{isset($model->relHrEmployee->relUser->relUserProfile->last_name)? $model->relHrEmployee->relUser->relUserProfile->last_name:''}}--}}
      {{--@endif--}}
    </h4>
</div>
