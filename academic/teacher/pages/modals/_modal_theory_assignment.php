...
<!-- Add Online Assignment Modal -->
<div class="modal fade" id="addAssignmentOnline" tabindex="-1" role="dialog" aria-labelledby="addAssignmentOnline" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="description" placeholder="Description here"></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="day" placeholder="12/12/2014">
                    </div>
...
<!-- Add Assign to Student or Group Modal -->
<div class="modal fade" id="assignToSt" tabindex="-1" role="dialog" aria-labelledby="assignToSt" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <h4 class="modal-title">Assign to Student or Group</h4>
            </div>
            <div class="modal-body">
                <form>
                    <div class="form-group">
...
<!-- View Online Assignment Details Modal -->
<div class="modal fade" id="viewOnlineAssignment" tabindex="-1" role="dialog" aria-labelledby="viewOnlineAssignment" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <h4 class="modal-title"> Assignment to Student/Group </h4>
            </div>
            <div class="modal-body">
                <h2> Data Analysis  </h2>
                <p> Topics <b>Data Structure</b></p>
