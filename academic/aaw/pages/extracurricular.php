...
<div class="wrapper row-offcanvas row-offcanvas-left">
    ...
    <aside class="right-side">
        ...
        <!-- START CUSTOM TABS -->
        <h2 class="page-header">Extracurricular Activities management :: AAW </h2>
        <div class="row">
        <div class="col-md-12">
        <!-- Custom Tabs -->
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> Open </td>
                                <td width="140">
                                    <button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#addExtraCurricular">
                                        Edit
                                    </button>
                                    <button class="btn btn-default btn-xs" data-toggle="modal" data-target="#viewDetails">
                                        View
                                    </button>
                                    <button class="btn btn-primary btn-xs" data-toggle="modal" data-target="#permitModal">
                                        Permitted
                                    </button>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-success btn-xs" data-toggle="modal" data-target="#approveModal">
                                        Approve
                                    </button>
