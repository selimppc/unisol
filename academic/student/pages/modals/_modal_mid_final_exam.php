...
<div class="modal fade" id="addInstruction" tabindex="-1" role="dialog" aria-labelledby="addInstruction"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="datemask" class="form-control" data-inputmask="'alias': 'dd/mm/yyyy'"
                                   data-mask/>
                        </div>
                    </div>
