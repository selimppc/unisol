                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td> There are countless opportunities to join a University sport club
                                                </td>
                                                <td> Male</td>
                                                <td> Fierce, competition is guaranteed through the intercollegiate
                                                    'Cuppers'
                                                </td>
                                                <td> Student</td>
                                                <td> Open</td>
                                            ...
                                            <tr>
                                                <td> Drama</td>
                                                <td> Fry, John Cleese, Emma Thompson, Tilda Swinton, and Tom
                                                    Hiddleston
                                                </td>
                                                <td> Female</td>
                                            ...
                                            <tr>
                                                <td> Volunteering</td>
                                                <td> The Office of External Affairs and Communications' Public
                                                    Engagement team work closely
                                                </td>
                                                <td> Female</td>
                                                <td> volunteer</td>
                                                <td> Student</td>
