                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_1">
                                <button class="pull-right btn btn-success btn-sm"  data-toggle="modal" data-target="#addIssueRequest" >
                                        ...
                                        <?php for($i = 0; $i < 5; $i++){ ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button class="btn btn-default btn-xs" data-toggle="modal" data-target="#addIssueRequest">
                                                        Edit
                                                    </button>
