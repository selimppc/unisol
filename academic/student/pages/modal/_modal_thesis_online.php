<!-- Thesis Proposal -->
<div class="modal fade" id="thesisProposal" tabindex="-1" role="dialog" aria-labelledby="addPublications"
     aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        <label for="description">Thesis Description</label>
                        <textarea class="form-control" id="description" placeholder="Type Here"></textarea>
                    </div>

                    <div class="form-group">
                        <label for="exampleInputFile">Thesis Proposal File</label>
...
<!-- Thesis Presentation -->
<div class="modal fade" id="thesisPresentation" tabindex="-1" role="dialog" aria-labelledby="addPublications"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
...
<!-- Thesis Field Work -->
<div class="modal fade" id="thesisFieldWork" tabindex="-1" role="dialog" aria-labelledby="addPublications"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="description">Field Work Description</label>
                        ...
                        <div class="form-group">
                            <label for="exampleInputFile">Field Work Related Image</label>
                            <input type="file" id="exampleInputFile">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputFile">Field Work File/DOc </label>
                            <input type="file" id="exampleInputFile">
                        </div>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="description">Thesis Work Description</label>
                            <textarea class="form-control" id="description"
                                      placeholder="Description goes here"></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="exampleInputFile">Presentation File/DOc </label>
                            <input type="file" id="exampleInputFile">
                        </div>
                        <div class="form-group">
...
<!-- Report Presentation -->
<div class="modal fade" id="reportPresentation" tabindex="-1" role="dialog" aria-labelledby="addPublications"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span
                        class="sr-only">Close</span></button>
                <h4 class="modal-title">Report Presentation</h4>
            </div>
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="description">Thesis Report Description</label>
                            <textarea class="form-control" id="description"
                                      placeholder="Description goes here"></textarea>
                        </div>

                        <div class="form-group">
                            <label for="exampleInputFile">Thesis Report File/DOc </label>
                            <input type="file" id="exampleInputFile">
                        </div>
