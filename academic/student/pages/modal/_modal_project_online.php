                        ...
                        <tr>
                            ...
                            <td width="130">
                                <button class="btn btn-primary btn-xs" data-toggle="modal"
                                        data-target="#assignProjectToONE">
                                    Assign to only ONE
                                </button>
...
<!-- Edit Research Review Modal -->
<div class="modal fade" id="evaluationProjectMarks" tabindex="-1" role="dialog" aria-labelledby="addResearchReview"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
