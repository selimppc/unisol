        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        <label for="exampleInputFile">Project Proposal File</label>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="description">Project Work Description</label>
                            <textarea class="form-control" id="description"
                                      placeholder="Description goes here"></textarea>
                        </div>
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="description">Project Report Description</label>
                            <textarea class="form-control" id="description"
                                      placeholder="Description goes here"></textarea>
                        </div>
