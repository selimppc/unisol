                    ...
                    <div class="bs-example tab-pane active" id="tab_1">
                        ...
                        <div class="btn-group">
                            <button type="button" class=" btn-danger" data-toggle="modal"
                                    data-target="#thesisPresentation">Propose Presentation
                            </button>
                        ...
                        <div class="btn-group">
                            <button type="button" class=" btn-warning" data-toggle="modal"
                                    data-target="#thesisFieldWork">Fieldwork
                            </button>
                        ...
                        <div class="btn-group">
                            <button type="button" class=" btn-default" data-toggle="modal"
                                    data-target="#thesisPresentation">Thesis Presentation
                            </button>
                        </div>
                        ...
                        <div class="box-body table-responsive">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td> 12/02/15</td>
                                    <td> UI not mandatory but Library System management Program should be running error
                                        free.
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td> Structure Programming Language</td>
                                    <td> 02/02/15</td>
                                    <td> School Management System application should be run in the server so that local
                                ...
                                <tr>
                                    ...
                                    <td> Java</td>
                                    <td> 12/12/12</td>
                                    <td> Most of the scientific calculator option have to be included in this apps.</td>
                                    <td>
                                            <span data-toggle="modal" data-target="#viewDetails">
                                                <img src="../img/doc.png" width="100px" style="cursor: pointer"
                                                     class="img-thumbnail">
