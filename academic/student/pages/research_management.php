...
<!-- START CUSTOM TABS -->
<h2 class="page-header">Research Management : Student </h2>
...
<ul class="nav nav-tabs">
    <li class="active"><a href="#tab_1" data-toggle="tab">Research </a></li>
    ...
    <li class="dropdown">
        ...
        <ul class="dropdown-menu">
            <li role="presentation" data-toggle="modal" data-target="#addFreeType"><a role="menuitem" tabindex="-1"
                                                                                      href="#"> Add Free Type </a></li>
            <li role="presentation" data-toggle="modal" data-target="#addJournal"><a role="menuitem" tabindex="-1"
                                                                                     href="#"> Add Journal </a></li>
        </ul>
    </li>
    ...
    <div class="box-body table-responsive">
        <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <th>Free Type</th>
                <th>Searching</th>
                <th>Benefit share with University (%)</th>
                <th>Status</th>
                <th>Action</th>
            </tr>
            </thead>
        ...
        <table id="example3" class="table table-bordered table-striped">
            ...
            <?php for ($i = 0; $i < 5; $i++) { ?>
                ...
                <tr>
                    ...
                    <td> Addiction is defined as a chronic, relapsing brain disease that is characterized by compulsive
