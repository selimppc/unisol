...
!(function (g) {
    g.extend({
        tablesorter: new function () {
            ...
            function x(a) {
                var b = a.config, d = b.$tbodies = b.$table.children("tbody:not(." + b.cssInfoBlock + ")"), h, y, f, l, r, g, n = "";
                if (0 === d.length)return b.debug ? c("*Empty table!* Not building a parser cache") : "";
                d = d[0].rows;
                if (d[0])for (h = [], y = d[0].cells.length, f = 0; f < y; f++) {
                    l = b.$headers.filter(":not([colspan])");
                    l = l.add(b.$headers.filter('[colspan="1"]')).filter('[data-column="' + f + '"]:last');
                    r = b.headers[f];
                    g = e.getParserById(e.getData(l, r, "sorter"));
                    b.empties[f] = e.getData(l, r, "empty") || b.emptyTo || (b.emptyToBottom ? "bottom" : "top");
                    b.strings[f] = e.getData(l, r, "string") || b.stringTo || "max";
                    if (!g)a:{
                        l = a;
                        r = d;
                        g = -1;
                        for (var A = f, k = void 0, m = e.parsers.length, t = !1, v = "", k = !0; "" === v && k;)g++, r[g] ? (t = r[g].cells[A], v = p(l, t, A), l.config.debug && c("Checking if value was empty on row " + g + ", column: " + A + ': "' + v + '"')) : k = !1;
                        for (; 0 <= --m;)if ((k = e.parsers[m]) && "text" !== k.id && k.is && k.is(v, l, t)) {
                            g = k;
                            break a
                        }
            ...
            function z(a) {
                var b = a.tBodies, d = a.config, h, y, f = d.parsers, l, r, q, n, A, m, w, t = [];
                d.cache = {};
                if (!f)return d.debug ? c("*Empty table!* Not building a cache") : "";
                d.debug && (w = new Date);
                d.showProcessing && e.isProcessing(a, !0);
                for (n = 0; n < b.length; n++)if (d.cache[n] = {row: [], normalized: []}, !g(b[n]).hasClass(d.cssInfoBlock)) {
                    h = b[n] && b[n].rows.length || 0;
                    y = b[n].rows[0] && b[n].rows[0].cells.length || 0;
                    for (r = 0; r < h; ++r)if (A = g(b[n].rows[r]), m = [], A.hasClass(d.cssChildRow))d.cache[n].row[d.cache[n].row.length - 1] = d.cache[n].row[d.cache[n].row.length - 1].add(A); else {
                        d.cache[n].row.push(A);
                        for (q = 0; q < y; ++q)l = p(a, A[0].cells[q], q), l = f[q].format(l, a, A[0].cells[q], q), m.push(l), "numeric" === (f[q].type || "").toLowerCase() && (t[q] = Math.max(Math.abs(l) || 0, t[q] || 0));
                ...
                d.debug && k("Building cache for " + h + " rows", w)
            }

            function B(a, b) {
                var d = a.config, h = a.tBodies, c = [], f = d.cache, l, r, q, n, A, p, w, t, v, s, u;
                if (!m(f)) {
                    d.debug && (u = new Date);
                    for (t = 0; t < h.length; t++)if (l = g(h[t]), l.length && !l.hasClass(d.cssInfoBlock)) {
                        A = e.processTbody(a, l, !0);
                        l = f[t].row;
                        r = f[t].normalized;
                        n = (q = r.length) ? r[0].length - 1 : 0;
                        for (p = 0; p < q; p++)if (s = r[p][n], c.push(l[s]), !d.appender || !d.removeRows)for (v = l[s].length, w = 0; w < v; w++)A.append(l[s][w]);
                        e.processTbody(a, A, !1)
                    }
                    d.appender && d.appender(a, c);
                    d.debug && k("Rebuilt table", u);
                    b || e.applyWidget(a);
            ...
            function E(a) {
                var b = [], d = {}, h = 0, c = g(a).find("thead:eq(0), tfoot").children("tr"), f, l, e, q, n, k, m, p, t, v;
                for (f = 0; f < c.length; f++)for (n = c[f].cells, l = 0; l < n.length; l++) {
                    q = n[l];
                    k = q.parentNode.rowIndex;
                    m = k + "-" + q.cellIndex;
                    p = q.rowSpan || 1;
                    t = q.colSpan || 1;
                    "undefined" === typeof b[k] && (b[k] = []);
                    for (e = 0; e < b[k].length + 1; e++)if ("undefined" === typeof b[k][e]) {
                        v = e;
                        break
                    }
                    d[m] = v;
                    ...
                    for (e = k; e < k + p; e++)for ("undefined" === typeof b[e] && (b[e] = []), m = b[e], q = v; q < v + t; q++)m[q] = "x"
                }
            ...
            function C(a) {
                var b = E(a), d, h, y, f, l, r, q, n = a.config;
                n.headerList = [];
                n.headerContent = [];
                n.debug && (q = new Date);
                ...
                n.$headers = g(a).find(n.selectorHeaders).each(function (a) {
                    ...
                    l = n.headerTemplate.replace(/\{content\}/g, g(this).html()).replace(/\{icon\}/g, f);
                    n.onRenderTemplate && (y = n.onRenderTemplate.apply(h, [a, l])) && "string" === typeof y && (l = y);
                ...
                D(a);
                n.debug && (k("Built headers:", q), c(n.$headers))
            }
            ...
            function H(a) {
                var b, d, h, c = a.config, f = c.sortList, l = [e.css.sortAsc + " " + c.cssAsc, e.css.sortDesc + " " + c.cssDesc], r = g(a).find("tfoot tr").children().removeClass(l.join(" "));
                c.$headers.removeClass(l.join(" "));
                h = f.length;
                for (b = 0; b < h; b++)if (2 !== f[b][1] && (a = c.$headers.not(".sorter-false").filter('[data-column="' + f[b][0] + '"]' + (1 === h ? ":last" : "")), a.length))for (d = 0; d < a.length; d++)a[d].sortDisabled || (a.eq(d).addClass(l[f[b][1]]), r.length && r.filter('[data-column="' + f[b][0] + '"]').eq(d).addClass(l[f[b][1]]))
            }
            ...
            function M(a, b) {
                ...
                g.each(e, function (a, b) {
                    ...
                    if (c = f.headerList[d[0]])f.sortList.push(d), h = g.inArray(d[1], c.order), c.count = 0 <= h ? h : d[1] % (f.sortReset ? 3 : 2)
                })
            }

            function N(a, b, d) {
                var h, c, f = a.config, l = !d[f.sortMultiSortKey], r = g(a);
                r.trigger("sortStart", a);
                b.count = d[f.sortResetKey] ? 2 : (b.count + 1) % (f.sortReset ? 3 : 2);
                f.sortRestart && (c = b, f.$headers.each(function () {
                    this === c || !l && g(this).is("." + e.css.sortDesc + ",." + e.css.sortAsc) || (this.count = -1)
                }));
                c = b.column;
                if (l) {
                    f.sortList = [];
                    if (null !== f.sortForce)for (h = f.sortForce, d = 0; d < h.length; d++)h[d][0] !== c && f.sortList.push(h[d]);
                    h = b.order[b.count];
                    if (2 > h && (f.sortList.push([c, h]), 1 < b.colSpan))for (d = 1; d < b.colSpan; d++)f.sortList.push([c + d, h])
                } else if (f.sortAppend && 1 < f.sortList.length && e.isValueInArray(f.sortAppend[0][0], f.sortList) && f.sortList.pop(), e.isValueInArray(c, f.sortList))for (d = 0; d < f.sortList.length; d++)b = f.sortList[d], h = f.headerList[b[0]], b[0] === c && (b[1] = h.order[h.count], 2 === b[1] && (f.sortList.splice(d, 1), h.count = -1)); else if (h = b.order[b.count], 2 > h && (f.sortList.push([c, h]), 1 < b.colSpan))for (d = 1; d < b.colSpan; d++)f.sortList.push([c + d, h]);
                if (null !== f.sortAppend)for (h = f.sortAppend, d = 0; d < h.length; d++)h[d][0] !== c && f.sortList.push(h[d]);
            ...
            function I(a) {
                var b, d, h, c, f, l, g, q, n, p, u, w, t, v = 0, s = a.config, x = s.textSorter || "", z = s.sortList, B = z.length, C = a.tBodies.length;
                if (!s.serverSideSorting && !m(s.cache)) {
                    s.debug && (p = new Date);
                    for (d = 0; d < C; d++)l = s.cache[d].colMax, n = (g = s.cache[d].normalized) && g[0] ? g[0].length - 1 : 0, g.sort(function (d, g) {
                        for (b = 0; b < B; b++) {
                            f = z[b][0];
                            q = z[b][1];
                            w = (v = 0 === q) ? d : g;
                            ...
                            if ("" === w[f] && 0 !== h)return ("boolean" === typeof h ? h ? -1 : 1 : h || 1) * (v ? 1 : -1);
                            if ("" === t[f] && 0 !== h)return ("boolean" === typeof h ? h ? 1 : -1 : -h || -1) * (v ? 1 : -1);
                    ...
                    s.debug && k("Sorting on " + z.toString() + " and dir " + q + " time", p)
                }
            }
            ...
            function K(a) {
                ...
                d.unbind("sortReset update updateRows updateCell updateAll addRows sorton appendCache applyWidgetId applyWidgets refreshWidgets destroy mouseup mouseleave ".split(" ").join(".tablesorter ")).bind("sortReset.tablesorter", function (d) {
                    ...
                    D(a);
                    F(a, d, h)
                }).bind("updateCell.tablesorter", function (h, c, e, k) {
                    h.stopPropagation();
                    ...
                    c = g(c)[0];
                    n.length && 0 <= h && (y = n.eq(h).find("tr").index(w), m = c.cellIndex, n = b.cache[h].normalized[y].length - 1, b.cache[h].row[a.config.cache[h].normalized[y][n]] = w, b.cache[h].normalized[y][m] = b.parsers[m].format(p(a, c, m), a, c, m), G(d, e, k))
                }).bind("addRows.tablesorter", function (c, e, g, k) {
                    c.stopPropagation();
                    var n = e.filter("tr").length, y = [], m = e[0].cells.length, w = d.find("tbody").index(e.parents("tbody").filter(":first"));
                    b.parsers || x(a);
                    for (c = 0; c < n; c++) {
                        for (h = 0; h < m; h++)y[h] = b.parsers[h].format(p(a, e[c].cells[h], h), a, e[c].cells[h], h);
            ...
            e.setup = function (a, b) {
                ...
                b.delayInit || z(a);
                K(a);
                b.supportsDataObject && "undefined" !== typeof h.data().sortlist ? b.sortList = h.data().sortlist : k && h.metadata() && h.metadata().sortlist && (b.sortList = h.metadata().sortlist);
                e.applyWidget(a, !0);
            ...
            e.destroy = function (a, b, d) {
                ...
                if (a.hasInitialized) {
                    e.refreshWidgets(a, !0, !0);
                    var c = g(a), k = a.config, f = c.find("thead:first"), l = f.find("tr." + e.css.headerRow).removeClass(e.css.headerRow + " " + k.cssHeaderRow), m = c.find("tfoot:first > tr").children("th, td");
                    f.find("tr").not(l).remove();
                    ...
                    k.$headers.add(m).removeClass([e.css.header, k.cssHeader, k.cssAsc, k.cssDesc, e.css.sortAsc, e.css.sortDesc].join(" ")).removeAttr("data-column");
                    l.find(k.selectorSort).unbind("mousedown.tablesorter mouseup.tablesorter keypress.tablesorter");
                    e.restoreHeaders(a);
                    !1 !== b && c.removeClass(e.css.table + " " + k.tableClass + " tablesorter-" + k.theme);
                    a.hasInitialized = !1;
                    "function" === typeof d && d(a)
                }
            };
            ...
            e.sortNatural = function (a, b) {
                ...
                for (l = 0; l < k; l++) {
                    g = isNaN(d[l]) ? d[l] || 0 : parseFloat(d[l]) || 0;
                    f = isNaN(c[l]) ? c[l] || 0 : parseFloat(c[l]) || 0;
                    if (isNaN(g) !== isNaN(f))return isNaN(g) ? 1 : -1;
            ...
            e.replaceAccents = function (a) {
                ...
                if (!e.characterRegex) {
                    ...
                    for (b in c)"string" === typeof b && (d += c[b], e.characterRegexArray[b] = RegExp("[" + c[b] + "]", "g"));
                    e.characterRegex = RegExp(d + "]")
                }
                if (e.characterRegex.test(a))for (b in c)"string" === typeof b && (a = a.replace(e.characterRegexArray[b], b));
                return a
            };
            ...
            e.addParser = function (a) {
                ...
                for (b = 0; b < d; b++)e.parsers[b].id.toLowerCase() === a.id.toLowerCase() && (c = !1);
                c && e.parsers.push(a)
            };
            e.getParserById = function (a) {
                var b, d = e.parsers.length;
                for (b = 0; b < d; b++)if (e.parsers[b].id.toLowerCase() === a.toString().toLowerCase())return e.parsers[b];
                return !1
            };
            ...
            e.getWidgetById = function (a) {
                ...
                for (b = 0; b < c; b++)if ((d = e.widgets[b]) && d.hasOwnProperty("id") && d.id.toLowerCase() === a.toLowerCase())return d
            };
            e.applyWidget = function (a, b) {
                a = g(a)[0];
                var d = a.config, c = d.widgetOptions, m = [], f, l, p;
                d.debug && (f = new Date);
                ...
                d.debug && (l = d.widgets.length, k("Completed " + (!0 === b ? "initializing " : "applying ") + l + " widget" + (1 !== l ? "s" : ""), f))
            };
            e.refreshWidgets = function (a, b, d) {
                a = g(a)[0];
                var h, k = a.config, f = k.widgets, l = e.widgets, m = l.length;
                for (h = 0; h < m; h++)l[h] && l[h].id && (b || 0 > g.inArray(l[h].id, f)) && (k.debug && c("Refeshing widgets: Removing " + l[h].id), l[h].hasOwnProperty("remove") && (l[h].remove(a, k, k.widgetOptions), k.widgetInit[l[h].id] = !1));
                !0 !== d && e.applyWidget(a, b)
            };
            e.getData = function (a, b, c) {
                var e = "";
                a = g(a);
                var k, f;
                if (!a.length)return "";
                k = g.metadata ? a.metadata() : !1;
                f = " " + (a.attr("class") || "");
                "undefined" !== typeof a.data(c) || "undefined" !== typeof a.data(c.toLowerCase()) ? e += a.data(c) || a.data(c.toLowerCase()) : k && "undefined" !== typeof k[c] ? e += k[c] : b && "undefined" !== typeof b[c] ? e += b[c] : " " !== f && f.match(" " + c + "-") && (e = f.match(RegExp("\\s" + c + "-([\\w-]+)"))[1] || "");
                return g.trim(e)
            };
    ...
    p.addParser({
        id: "digit", is: function (c) {
            ...
            var m = p.formatFloat((c || "").replace(/[^\w,. \-()]/g, ""), k);
            return c && "number" === typeof m ? m : c ? g.trim(c && k.config.ignoreCase ? c.toLocaleLowerCase() : c) : c
        }, type: "numeric"
    });
    p.addParser({
    ...
    p.addParser({
        id: "ipAddress", is: function (c) {
            ...
            for (m = 0; m < z; m++)x += ("00" + u[m]).slice(-3);
    ...
    p.addWidget({
        id: "zebra", priority: 90, format: function (c, k, m) {
            var u, x, z, B, E, C, F = RegExp(k.cssChildRow, "i"), D = k.$tbodies;
            k.debug && (E = new Date);
            for (c = 0; c < D.length; c++)u = D.eq(c), C = u.children("tr").length, 1 < C && (z = 0, u = u.children("tr:visible"), u.each(function () {
                x = g(this);
                F.test(this.className) || z++;
                B = 0 === z % 2;
                x.removeClass(m.zebra[B ? 1 : 0]).addClass(m.zebra[B ? 0 : 1])
            }));
            k.debug && p.benchmark("Applying Zebra widget", E)
        }, remove: function (c, k, m) {
            var p;
            k = k.$tbodies;
            var x = (m.zebra || ["even", "odd"]).join(" ");
            for (m = 0; m < k.length; m++)p = g.tablesorter.processTbody(c, k.eq(m), !0), p.children().removeClass(x), g.tablesorter.processTbody(c, p, !1)
        }
    })
})(jQuery);
